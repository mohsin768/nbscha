<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit Artist Banner</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'artist-banner');
                echo form_open_multipart(admin_url_string('artists/banner/'.$artist->id),$attributes);?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="title" name="title" value="<?php echo $artist->title; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="subtitle" name="subtitle" value="<?php echo $artist->subtitle; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="label">
                    Banner Image<br/> <?php if($artist->banner_image!='') { echo $artist->banner_image; } ?>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="banner_image" name="banner_image" class="form-control" style="padding:0px;"  type="file">
                    <?php if($artist->banner_image!='') { ?>
