<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>SEO - Board Member <small><?php echo $team->name; ?></small></h2>
            ...
            <div class="x_content">
                ...
                echo form_open_multipart(admin_url_string('teams/seo/'.$team->id.'/'.$language),$attributes);?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="slug" name="slug" required value="<?php echo $team->slug; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="meta_title"  name="meta_title"  value="<?php echo $team->meta_title; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="meta_keywords"  name="meta_title"  value="<?php echo $team->meta_keywords; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <textarea class="form-control"  id="meta_desc"  name="meta_desc" ><?php echo $team->meta_desc; ?></textarea>
                    </div>
                    <div class="clearfix"></div>
                </div>
