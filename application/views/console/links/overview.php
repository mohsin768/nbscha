						...
						<?php
							...
							<div class="x_content">
	                            ...
	                            <?php endforeach; ?>
												...
												<div class="filter-col">
													Language:
													<select id="link_language" name="link_language" class="form-control filter">
	                            <option value=""> All </option>
	                            <?php foreach($this->languages_pair as $code => $name): ?>
	                                <option value="<?php echo $code; ?>" <?php if($this->session->userdata('link_language_filter')==$code){ echo 'selected'; }?>><?php echo $name; ?></option>
	                            <?php endforeach; ?>
	                        </select>
