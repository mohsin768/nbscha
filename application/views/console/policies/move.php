<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo $manual->title; ?> - Version:<?php echo $manual->version; ?>  <br/> Section: <?php echo $section->title; ?> - Change Section of Policy</h2>
            ...
            <div class="x_content">
                ...
                echo form_open_multipart(admin_url_string('policies/move/'.$manual->id.'/'.$section->id.'/'.$policy->id.'/'.$language),$attributes);?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select id="section" name="section" class="form-control">
                            ...
                            <?php foreach($sections as $sectionRow): $default = false; if($policy->section == $sectionRow['id']){ $default = true; } ?>
