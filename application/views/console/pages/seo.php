            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="slug" name="slug" required="required" value="<?php echo $page->slug; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="meta_title" name="meta_title" value="<?php echo $page->meta_title; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <textarea id="meta_desc" name="meta_desc" class="form-control"><?php echo $page->meta_desc; ?></textarea>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="meta_keywords" name="meta_keywords" value="<?php echo $page->meta_keywords; ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
