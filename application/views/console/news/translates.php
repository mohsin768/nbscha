<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>News Translates</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <span><a class="btn btn-primary btn-sm" href="<?php echo admin_url('news'); ?>" ><i class="fa fa-angle-double-left" aria-hidden="true"></i> &nbsp;Back</a></span>
                    </li>
                </ul>
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class=" last">
																	...
																	<a class="btn btn-info btn-xs" href="<?php echo admin_url('news/edit/'.$translates[$code]['id'].'/'.$code); ?>"name="Edit"><i class="fa fa-edit"></i> Edit</a>
																<?php } else{ ?>
																	<a class="btn btn-success btn-xs" href="<?php echo admin_url('news/edit/'.$news_id.'/'.$code.'/translate'); ?>"name="add"><i class="fa fa-plus"></i> Add</a>
																<?php } ?>
                                </td>
                            </tr>
													<?php endforeach; ?>
