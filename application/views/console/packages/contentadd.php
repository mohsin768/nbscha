    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'package-content-add');
                echo form_open_multipart(admin_url_string('packages/contentadd/'.$type.'/'.$package->id),$attributes);
                ?>
