    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'package-content-edit');
                echo form_open_multipart(admin_url_string('packages/contentedit/'.$type.'/'.$package->id.'/'.$content->id),$attributes);?>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 offset-md-3">
                        ...
                        <a class="btn btn-primary" href="<?php echo admin_url('packages/contents/'.$package->id); ?>">Cancel</a>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
