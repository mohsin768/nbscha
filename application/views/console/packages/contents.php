    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                    ...
                    <li style="padding:0px 5px;">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php echo admin_url('packages/contentadd/'.$contentTypeKey.'/'.$package->id); ?>"><?php echo $contentTypeName; ?></a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </li>
            ...
            <?php
                ...
                echo form_open(admin_url('packages/contentactions/'.$package->id),$attributes); 
            ?>
            <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class=" last">
                                <a href="<?php echo admin_url('packages/contentedit/'.$content['content_type'].'/'.$content['package_id'].'/'.$content['id']); ?>">Edit</a>
                                    | <a class="confirmDelete" href="<?php echo admin_url('packages/contentdelete/'.$content['package_id'].'/'.$content['id']); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
