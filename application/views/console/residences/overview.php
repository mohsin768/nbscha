                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="align-top "><i class="fa fa-home"></i> <?php echo $residence['name'];?> <br/> <i class="fa fa-map-marker"></i> <?php echo $residence['address'];?><br/><strong>Region:</strong><?php echo $regions[$residence['region_id']];?></td>
                                <td class=" align-top"><i class="fa fa-user"></i>  <?php echo $residence['first_name'].' '.$residence['last_name'];?><br/>
																             <i class="fa fa-envelope"></i>  <?php echo $residence['member_email'];?>, <i class="fa fa-phone"></i>  <?php echo $residence['member_phone'];?><br/>
																						 </td>
