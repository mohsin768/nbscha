                    ...
                    <table class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class=" last">
                                    <a href="<?php echo admin_url('blocks/editcategory/'.$category['id']); ?>">Edit</a>
                                    | <a class="confirmDelete" href="<?php echo admin_url('blocks/deletecategory/'.$category['id']); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
