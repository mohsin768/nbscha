                    ...
                    <table class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="align-center"><input style="text-align:center;" type="text" size="2" name="sort_order[<?php echo $slider['id'];?>]" value="<?php echo $slider['sort_order'];?>" /></td>
                                <td class="center-align"><?php echo $status[$slider['status']];?></td>
                                <td class=" last">
                                    <a href="<?php echo admin_url('sliders/edit/'.$slider['id']); ?>">Edit</a>
                                    | <a class="confirmDelete" href="<?php echo admin_url('sliders/delete/'.$slider['id']); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
