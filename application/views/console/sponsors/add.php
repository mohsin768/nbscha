    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'sponsor-add');
                echo form_open_multipart(admin_url_string('sponsors/add'),$attributes);
                ?>
                ...
                <div class="form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="fullname">Website
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo form_error('website'); ?>
                        <input type="text" id="website"  name="website"  value="<?php echo set_value('website'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
