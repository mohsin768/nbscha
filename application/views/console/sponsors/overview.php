                    ...
                    <table class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class=" "><?php echo $events[$sponsor['event']];?></td>
                                <td class=" "><?php echo $categories[$sponsor['category']];?></td>
                                <td class=" "><?php echo $sponsor['name'];?></td>
                                <td class="align-center"><input style="text-align:center;" type="text" size="2" name="sort_order[<?php echo $sponsor['id'];?>]" value="<?php echo $sponsor['sort_order'];?>" /></td>
                                <td class="center-align"><?php echo $status[$sponsor['status']];?></td>
                                <td class=" last">
                                    <a href="<?php echo admin_url('sponsors/edit/'.$sponsor['id']); ?>">Edit</a>
                                    | <a class="confirmDelete" href="<?php echo admin_url('sponsors/delete/'.$sponsor['id']); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
