        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <span><a class="btn btn-primary btn-sm" href="<?php echo admin_url('sponsors/addcategory'); ?>" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> &nbsp;Add New</a></span> 
                    </li>
                </ul>
            ...
            <?php
                ...
                echo form_open(admin_url('sponsors/categoryactions'),$attributes); 
            ?>
            <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table">
                        ...
                        <tbody>
                            ...
                            <tr class="even pointer">
                                ...
                                <td class="align-center"><input style="text-align:center;" type="text" size="2" name="sort_order[<?php echo $category['id'];?>]" value="<?php echo $category['sort_order'];?>" /></td>
                                <td class="center-align"><?php echo $status[$category['status']];?></td>
                                <td class=" last">
                                    <a href="<?php echo admin_url('sponsors/editcategory/'.$category['id']); ?>">Edit</a>
                                    | <a class="confirmDelete" href="<?php echo admin_url('sponsors/deletecategory/'.$category['id']); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
