    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'video-add');
                echo form_open_multipart(admin_url_string('videos/add'),$attributes);
                ?>
                ...
                <div class="form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="video_url">Youtube Video URL
                    <span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo form_error('video_url'); ?>
                        <input type="text" id="video_url" name="video_url" value="<?php echo set_value('video_url'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="video_date" name="date" value="<?php echo set_value('date'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
