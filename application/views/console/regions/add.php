    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'region-add');
                echo form_open(admin_url_string('regions/add'),$attributes);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="region_name" required name="region_name"  value="<?php echo set_value('region_name'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
