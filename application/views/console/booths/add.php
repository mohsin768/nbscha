<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Add Booth Type</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'booths-add');
                echo form_open_multipart(admin_url_string('booths/add'),$attributes);
                ?>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select id="event" name="package" required="required" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="price" name="price" required="required" value="<?php echo set_value('price'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo form_error('price'); ?>
                        <input type="number" id="number" name="number" required="required" min="1" value="<?php echo set_value('number'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
