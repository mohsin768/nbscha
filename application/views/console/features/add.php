    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'feature-add');
                echo form_open(admin_url_string('features/add'),$attributes);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="feature_title" required name="feature_title"  value="<?php echo set_value('feature_title'); ?>" class="form-control">
                    </div>
                    <div class="clearfix"></div>
                </div>
