						...
						<?php
							...
							<div class="x_content">
											...
											<div class="action-content ">
												...
												<div class="filter-col">
													Language:
													<select id="testimonial_language" name="testimonial_language" class="form-control filter">
	                            <option value=""> All </option>
	                            <?php foreach($this->languages_pair as $code => $name): ?>
	                                <option value="<?php echo $code; ?>" <?php if($this->session->userdata('testimonial_language_filter')==$code){ echo 'selected'; }?>><?php echo $name; ?></option>
	                            <?php endforeach; ?>
	                        </select>
