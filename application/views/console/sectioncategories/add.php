<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo $manual->title; ?> - Version:<?php echo $manual->version; ?> - Add Section Category</h2>
            ...
            <div class="x_content">
                ...
                <br />
                <?php
                $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'sectioncategory-add');
                echo form_open_multipart(admin_url_string('sectioncategories/add/'.$manual->id.'/'.$language),$attributes);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select id="category_type" name="category_type" class="form-control">
                            ...
                            <?php foreach($this->categoryTypes as $id => $name): ?>
                                <option value="<?php echo $id; ?>" <?php echo set_select('category_type',$id); ?>><?php echo $name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="clearfix"></div>
