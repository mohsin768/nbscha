...
<!-- Page Title -->
<title>SeniorPress | Senior Care & Health Services HTML Template</title>

<!-- Favicon and Touch Icons -->
<link href="<?php echo frontend_assets_url('images/favicon.png'); ?>" rel="shortcut icon" type="image/png">
<link href="<?php echo frontend_assets_url('images/apple-touch-icon.png'); ?>" rel="apple-touch-icon">
<link href="<?php echo frontend_assets_url('images/apple-touch-icon-72x72.png'); ?>" rel="apple-touch-icon" sizes="72x72">
<link href="<?php echo frontend_assets_url('images/apple-touch-icon-114x114.png'); ?>" rel="apple-touch-icon" sizes="114x114">
<link href="<?php echo frontend_assets_url('images/apple-touch-icon-144x144.png'); ?>" rel="apple-touch-icon" sizes="144x144">
...
<link  href="<?php echo frontend_assets_url('js/revolution-slider/css/settings.css'); ?>" rel="stylesheet" type="text/css"/>
<link  href="<?php echo frontend_assets_url('js/revolution-slider/css/layers.css'); ?>" rel="stylesheet" type="text/css"/>
<link  href="<?php echo frontend_assets_url('js/revolution-slider/css/navigation.css'); ?>" rel="stylesheet" type="text/css"/>
...
<div id="wrapper" class="clearfix">
        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord default">
            <a class="menuzord-brand pull-left flip" href="javascript:void(0)">
              <img src="<?php echo frontend_assets_url('images/logo-wide-white.png'); ?>" alt="">
            </a>
            <ul class="menuzord-menu">
              ...
              <li><a href="#home">Services</a>
                <ul class="dropdown">
                  <li><a href="page-services-gird.html">Services Gird</a></li>
                  <li><a href="page-services-list.html">Services List</a></li>
                  <li><a href="page-services-transportation.html">Transportation</a></li>
                  <li><a href="page-services-health-care.html">Home Health Care</a></li>
                  <li><a href="page-services-fitness-program.html">Fitness Program</a></li>
                  <li><a href="page-services-laundry.html">Personal Laundry</a></li>
                  <li><a href="page-services-restaurent.html">Restaurent</a></li>
                  <li><a href="page-services-library.html">Library</a></li>
                  <li><a href="page-services-swimming-pool.html">Swimming Pool</a></li>
                  <li><a href="page-services-combing-hair.html">Combing Hair</a></li>
                </ul>
              </li>
              <li><a href="#home">Experts</a>
                <ul class="dropdown">
                  <li><a href="page-experts-style1.html">Experts style 1</a></li>
                  <li><a href="page-experts-style2.html">Experts style 2</a></li>
                  <li><a href="page-experts-details.html">Experts Details</a></li>
                </ul>
              </li>
              <li><a href="#">Blog</a>
                <ul class="dropdown">
  ...
  <div class="main-content">
      ...
      <div class="rev_slider_wrapper">
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <!-- SLIDE 1 -->
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="https://via.placeholder.com/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="https://via.placeholder.com/1920x1280"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                style="z-index: 7; white-space: nowrap; font-weight:700;">SeniorPress
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-left-theme-color-2-6px pl-20 pr-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Care for the elderly people 
              </div>
            ...
            <!-- SLIDE 2 -->
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="https://via.placeholder.com/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              <!-- MAIN IMAGE -->
              <img src="https://via.placeholder.com/1920x1280"  alt=""  data-bgposition="center 40%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase  bg-theme-colored-transparent text-white font-raleway border-left-theme-color-2-6px border-right-theme-color-2-6px pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;">Help the elderly people
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">World's Best Senior Care
              </div>
            ...
            <!-- SLIDE 3 -->
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="https://via.placeholder.com/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              <!-- MAIN IMAGE -->
              <img src="https://via.placeholder.com/1920x1280"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Best Services
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">For The Elderly People  
              </div>
          ...
          <div class="row equal-height-inner">
            <div class="col-sm-12 col-md-4 pr-0 pr-sm-15 sm-height-auto mt-sm-0" data-margin-top="-150px">
              <div class="sm-height-auto bg-theme-colored-darker2">
                <div class="p-30">
                  <h3 class="text-uppercase text-white mt-0">Senior Care</h3>
            ...
            <div class="col-sm-12 col-md-4 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0" data-margin-top="-150px">
              <div class="sm-height-auto bg-theme-colored">
                <div class="p-30">
                  <h3 class="text-white text-uppercase mt-0">Daily Schedule</h3>
                  <div class="opening-hours">
                    <ul class="list-unstyled text-white">
                      <li class="clearfix"> <span> Breakfast </span>
                        <div class="value"> 08.30 - 09.30 </div>
                      </li>
                      <li class="clearfix"> <span> Exercise </span>
                        <div class="value"> 09.30 - 10.30 </div>
                      </li>
                      <li class="clearfix"> <span> Library </span>
                        <div class="value"> 10.30 - 12.30 </div>
                      </li>
                    </ul>
                  </div>
            ...
            <div class="owl-carousel-3col owl-nav-top" data-dots="true">
              <div class="item">
                <div class="project mb-30 border-2px">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="" src="https://via.placeholder.com/370x285">
                    <div class="hover-link">
                    </div>
                  </div>
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Transportation.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Home Health Care.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Fitness Program.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Personal Laundry.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Senior Care Restaurent.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Senior Care Library.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
              ...
              <div class="item">
                <div class="project mb-30 border-2px">
                  ...
                  <div class="project-details p-0">
                    <div class="border-bottom-2px pt-10 pb-10 bg-theme-color-2">
                      <h4 class="font-weight-700 text-uppercase text-center mt-10"><a href="page-services-transportation.html" class="text-white">Senior Care SwimmingPool.</a></h4>
                    </div>
                    <p class="p-30 pb-10 text-center">Lorem ipsum dolor sit amet, consectetur adip iscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                    <a href="#" class="btn btn-default font-14 btn-circled btn-dark btn-theme-colored mt-0 ml-120 mb-30 hvr-bounce-to-left no-border">Read More</a>
                  </div>
    ...
    <section id="mission">
      <div class="container-fluid pt-0 pb-0">
        <div class="row equal-height">
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none"> 
                  <i class="fa fa-hospital-o text-theme-color-2 font-36"></i> 
                </a>
                <div class="ml-120 ml-sm-0">
                  <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">World Best Hospital</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none">
                  <i class="fa fa-users text-theme-color-2 font-36"></i> 
                </a>
                <div class="ml-120 ml-sm-0">
                  <h4 class="icon-box-title text-white mt-5 mb-10 letter-space-1">World Best Professional</h4>
                  <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam. </p>
                </div>
              </div>
              <div class="icon-box clearfix m-0 p-0 pb-10">
          ...
          <div class="col-sm-6 col-md-6 p-0 bg-img-cover wow fadeInRight hidden-xs" data-bg-img="https://via.placeholder.com/800x455" data-wow-duration="1s" data-wow-delay="0.3s">
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="mt-0 line-height-1 text-uppercase">Our <span class="text-theme-color-2">Experts</span></h2>
            ...
            <div class="owl-carousel-4col" data-nav="true">
              <div class="item">
                <div class="hover-effect mb-30">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="" src="https://via.placeholder.com/260x300">
                    <div class="hover-link">
                  ...
                  <div class="details p-15 pt-10 pb-10">
                    ...
                    <h5 class="sub-title mt-0 mb-15">Math Teacher</h5>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-7 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="https://via.placeholder.com/155x116" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/1.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/2.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/3.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/4.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/5.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/6.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/7.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/8.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/9.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/10.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/11.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo frontend_assets_url('images/gallery/12.jpg'); ?>"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-5 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase title line-bottom mt-0">FAQ</h3>
    ...
    <!-- Section: Claints Say -->
    <section class="divider parallax layer-overlay overlay-theme-color-sky" data-bg-img="https://via.placeholder.com/1920x1280">
      <div class="container pt-60 pb-70">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase text-white line-bottom-center mt-0">What Claint's <span class="text-theme-color-2">Say</span></h2>
            ...
            <div class="owl-carousel-3col  style2 dots-white" data-dots="false">
              <div class="item">
                <div class="testimonial bg-theme-color-2 p-30 pb-20 mt-50">
                  ...
                  <div class="thumb content mt-30"><img class="img-circle" alt="" src="https://via.placeholder.com/70x70"></div>
    ...
    <section>
      <div class="container pt-40 pb-60">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 wow fadeInLeft mt-20 pr-30" data-wow-duration="1s" data-wow-delay="0.3s">
                  ...
                  <div class="pricing table-horizontal maxwidth400">
                    <div class="row">
                      <div class="col-md-6 event-time">
                        <div class="thumb">
                        <img class="img-fullwidth mb-sm-0" src="https://via.placeholder.com/270x250" alt="">
                        </div>
                        <div class="event-date media-left flip text-center">
                          <ul>
                      ...
                      <div class="col-md-6 p-30 pb-20 pl-sm-50">
                        <h4 class="mt-0 mb-5"><a href="#" class="text-white">Upcoming Events Title</a></h4>
                        <ul class="list-inline mb-5 text-white">
                          <li class="pl-5"><i class="fa fa-map-marker font-20 mr-5"></i>Linkon Hall, New York.</li>
                        </ul>
    ...
    <!-- Section: Blog -->
    <section id="blog" class="divider parallax layer-overlay overlay-dark-8" data-stellar-background-ratio="0.5" data-bg-img="https://via.placeholder.com/1920x1280">
      <div class="container pt-70 pb-70">
        <div class="section-title mb-20 text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="mt-0 line-height-1 text-uppercase text-white">Recent  <span class="text-theme-color-2"> News</span></h2>
              <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem obcaecati!</p>
            </div>
          </div>
        </div>
              ...
              <article class="post clearfix mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="https://via.placeholder.com/370x247" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content bg-white p-20 pr-10">
                  <div class="entry-meta mt-0 no-border">
                    <div class="event-content">
                      <h4 class="entry-title text-white text-capitalize m-0"><a href="#">This is a standard post with thumbnail</a></h4>
                    </div>
                  </div>
                  <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti, sint assumenda. Pariatur iste veritatis excepturi, ipsa optio nobis. <a href="#" class="text-theme-colored font-15 pl-20"> Read More →</a></p>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="owl-carousel-6col transparent text-center owl-nav-top">
              <div class="item"> <a href="#"><img src="https://via.placeholder.com/200x120" alt=""></a></div>
              <div class="item"> <a href="#"><img src="https://via.placeholder.com/200x120" alt=""></a></div>
              <div class="item"> <a href="#"><img src="https://via.placeholder.com/200x120" alt=""></a></div>
              <div class="item"> <a href="#"><img src="https://via.placeholder.com/200x120" alt=""></a></div>
              <div class="item"> <a href="#"><img src="https://via.placeholder.com/200x120" alt=""></a></div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mt-10 mb-15" alt="" src="<?php echo frontend_assets_url('images/logo-wide-white.png'); ?>">
          ...
          <div class="widget dark">
            ...
            <div class="latest-posts">
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb"><img alt="" src="https://via.placeholder.com/80x55"></a>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-border">
              ...
              <li><a href="page-contact-style1.html">Contact</a></li>
            </ul>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
