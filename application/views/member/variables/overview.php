        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <span><a class="btn btn-primary btn-sm" href="<?php echo member_url('variables/add/'.$manual->id.'/'.$language); ?>" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> &nbsp;Add New</a></span>
                    </li>
										<li>
                        <span><a class="btn btn-primary btn-sm" href="<?php echo member_url('variables/overview'); ?>" ><i class="fa fa-back" aria-hidden="true"></i> &nbsp;Back</a></span>
                    </li>
                </ul>
						...
						<?php
							...
							<div class="x_content">
											...
											<div class="action-content ">
												...
												<div class="filter-col">
													Language:
													<select id="variable_language" name="variable_language" class="form-control filter">
	                            <option value=""> All </option>
	                            <?php foreach($this->languages_pair as $code => $name): ?>
	                                <option value="<?php echo $code; ?>" <?php if($this->session->userdata('variable_language_filter')==$code){ echo 'selected'; }?>><?php echo $name; ?></option>
	                            <?php endforeach; ?>
	                        </select>
                        ...
                        <thead>
                            <tr class="headings">
															...
															<th class="column-title">
																<?php $title_direction = ''; if($sort_field=='variable_value'){ $title_direction = $sort_direction; } ?>
																<a href="#0" class="variable-sort sort-list-link <?php echo $title_direction; ?>" data-sort-field="variable_value" data-sort-direction="<?php echo $title_direction; ?>">Original Value</a></th>

																<th class="column-title">Custom Value</th>
