<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Change Password for <?php echo $user->first_name.' '.$user->last_name; ?></h2>
            ...
            <div class="x_content">
                ...
                echo form_open(member_url_string('home/changepwd'),$attributes);
                ?>
                ...
                <div class="item form-group">
                    <div class="col-md-6 col-sm-6 offset-md-3">
                        ...
                        <a class="btn btn-primary" href="<?php echo member_url('home/'); ?>">Cancel</a>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
